...
frequencyCount: hashTable.o  frequencyCount.o qsortASM.o stringCompASM.o
	gcc  -std=c99 -m32 -Wall -pedantic -g hashTable.o frequencyCount.o qsortASM.o stringCompASM.o -o frequencyCount


frequencyCount.o: frequencyCount.c hashTable.c hashTable.h
	gcc -c -m32 -Wall -pedantic -g -std=c99 frequencyCount.c


hashTable.o: hashTable.c hashTable.h
	gcc -c -m32 -Wall -pedantic -g -std=c99 hashTable.c
